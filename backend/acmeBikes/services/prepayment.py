...
def prepayment(process_instance_id, process_dict, order):
    ...
    try:
        ...
        msg.add_process_variable(name="pre_payment_token", value=payment.text)
        msg.add_process_variable(name="pre_payment_amount", value=amount)
        msg()
