...
def token_refused(process_instance_id, process_dict):
    load_dotenv()
    CAMUNDA_URL = os.getenv("CAMUNDA_URL")
    print(f"token_refused {process_instance_id}")
    try:
        ...
        msg = CorrelateSingle(CAMUNDA_URL, message_name="token_refused",
